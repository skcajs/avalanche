...
gui.add(pointLight, 'intensity').min(0).max(1).step(0.01).name('pointLight')
gui.add(rectAreaLight, 'intensity').min(0).max(4).step(0.01).name('rectAreaLight')
gui.add(spotLight, 'intensity').min(0).max(1).step(0.01).name('spotLight')
